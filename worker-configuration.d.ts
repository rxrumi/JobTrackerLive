/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 15867d6edaa98ca896656017c18ec435)
...
interface __BaseEnv_Env {
	...
	SCAN_COORDINATOR: DurableObjectNamespace<import("./src/worker").ScanCoordinator>;
	USER_COORDINATOR: DurableObjectNamespace<import("./src/worker").UserMutationCoordinator>;
	RATE_LIMITER: DurableObjectNamespace<import("./src/worker").RateLimitCoordinator>;
	RESUME_WORKFLOW: Workflow /* ResumeBuildWorkflow from job-tracker-resume-workflow */;
	ACCOUNT_WORKFLOW: Workflow /* AccountLifecycleWorkflow from job-tracker-resume-workflow */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "ScanCoordinator" | "UserMutationCoordinator" | "RateLimitCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RESUME_STUDIO_ENABLED" | "RESUME_DAILY_MATCHING_ENABLED" | "RESUME_AUTO_BUILD_ENABLED" | "RESUME_EMAIL_DIGESTS_ENABLED" | "CREDIT_ENFORCEMENT_ENABLED" | "BETA_APPLICATION_PACK_CREDITS" | "RESUME_ROLLOUT_PERCENT" | "RESUME_DAILY_BUILD_LIMIT" | "RESUME_DAILY_AI_BUDGET_USD" | "RESUME_MODEL" | "REQUIRE_AI_GATEWAY" | "RESUME_EMAIL_FROM" | "PRIVACY_POLICY_VERSION" | "ANALYTICS_RETENTION_DAYS">> {}
}
